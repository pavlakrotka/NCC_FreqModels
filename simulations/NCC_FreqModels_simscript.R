...
setting_1_splines_alpha <- data.frame(num_arms = 10, 
                                      ...
                                      lambda8 = rep(seq(-0.5, 0.5, length.out = 9), each = 9),
                                      lambda9 = rep(seq(-0.5, 0.5, length.out = 9), each = 9),
                                      lambda10 = rep(seq(-0.5, 0.5, length.out = 9), each = 9),
                                      ...
                                      N_peak = c(rep(NA, 81*2), rep(1660, 81), rep(NA, 81*2)))
