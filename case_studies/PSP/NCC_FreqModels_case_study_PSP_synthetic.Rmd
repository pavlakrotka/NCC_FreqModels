...
This file contains all code to generate synthetic data in order to mimic the case study using PSP data presented in Section 5.1 of the paper *"Statistical modeling to adjust for time trends in adaptive platform trials utilizing non-concurrent controls"* by Pavla Krotka, Martin Posch, Mohamed Gewily, Günter Höglinger, Marta Bofill Roig.
